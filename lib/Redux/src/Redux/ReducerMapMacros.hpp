...
#define _REDUX_REDUCERMAP_INIT_BEGIN(CLASS) CLASS(const CLASS * previous) :
#define _REDUX_REDUCERMAP_INIT_FIELD(CLASS, FIELD, REDUCER) FIELD(REDUCER.init(previous ? previous->FIELD : nullptr)->as<CLASS>())
